...
INSERT INTO "new_quiz_attempts" ("completedAt", "id", "participantEmail", "participantInfo", "participantName", "passed", "quizId", "score", "startedAt", "timeTaken", "userId") SELECT "completedAt", "id", "participantEmail", "participantInfo", "participantName", "passed", "quizId", "score", "startedAt", "timeTaken", "userId" FROM "quiz_attempts";
