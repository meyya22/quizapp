    ...
    return (
      <div className="space-y-1">
        ...
        <textarea
          ...
          id={inputId}
          rows={3}
          className={`block w-full rounded-lg border px-3 py-2 text-sm shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none ${
            error ? 'border-red-300 bg-red-50' : 'border-slate-300 bg-white'
          } ${className}`}
          {...props}
        />
