...
export default function Footer() {
  return (
    <footer className="w-full text-center py-3 px-4 text-[10px] text-slate-400 border-t border-slate-100 bg-white/50">
      <div className="flex items-center justify-center gap-4 mb-2">
        <a href="https://twitter.com/_topstudent" target="_blank" rel="noopener noreferrer" title="Twitter / X" className="text-slate-400 hover:text-slate-700 transition-colors">
          <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.713 6.231z"/></svg>
        </a>
      ...
      <div className="flex items-center justify-center gap-3 flex-wrap">
        <span>© 2026 Xam Bridge — All rights reserved</span>
        <span className="text-slate-300">·</span>
        <Link to="/about" className="hover:text-slate-600 transition-colors underline underline-offset-2">
          About Us
        </Link>
        <span className="text-slate-300">·</span>
        <Link to="/faq" className="hover:text-slate-600 transition-colors underline underline-offset-2">
          FAQ
        </Link>
        <span className="text-slate-300">·</span>
