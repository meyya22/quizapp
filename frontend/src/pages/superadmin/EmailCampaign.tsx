...
import {
  ...
  ChevronDown, ChevronUp, Pencil, CheckCircle, AlertCircle, History, X, Eye,
} from 'lucide-react';
                ...
                {TEMPLATES.map((t) => (
                  ...
                  >
                    <button className="text-left w-full" onClick={() => applyTemplate(t)}>
                      <p className={`text-xs font-semibold pr-6 ${activeTemplate === t.id ? 'text-blue-700' : 'text-slate-700'}`}>
                        {t.name}
                      </p>
                    ...
                    <button
                      ...
                      title="Preview"
                      className="absolute top-2.5 right-2.5 text-slate-400 hover:text-blue-600 transition-colors"
                    >
