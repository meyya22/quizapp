...
- Instant scoring with pass/fail results and detailed explanations for every answer
- Questions crafted by educators, industry professionals, and publishers across the platform
- Available in 9 languages: Hindi, Bengali, Tamil, Telugu, Marathi, Gujarati, Spanish, Portuguese & Indonesian

Log in to your Xam Bridge account and head to the Quizzes tab. Browse by category, take a quiz that matters to you, and see how you score.

Hundreds of quizzes. Thousands of questions. All for you — free.`,
  },
  {
    id: 2,
    name: 'Come Back',
